...
// TNKData
#define COCOAPODS_POD_AVAILABLE_TNKData
#define COCOAPODS_VERSION_MAJOR_TNKData 0
#define COCOAPODS_VERSION_MINOR_TNKData 1
#define COCOAPODS_VERSION_PATCH_TNKData 0
